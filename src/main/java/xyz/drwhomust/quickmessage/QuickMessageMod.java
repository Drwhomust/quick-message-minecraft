package xyz.drwhomust.quickmessage;
...
@Mod("quick_message")
public class QuickMessageMod {
	public static final Logger LOGGER = LogManager.getLogger(QuickMessageMod.class);
	public static final String MODID = "quick_message";

	public QuickMessageMod(IEventBus modEventBus) {
